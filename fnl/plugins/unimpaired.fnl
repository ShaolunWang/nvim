{1 :tummetott/unimpaired.nvim
 ...
 :opts {:default_keymaps true
        ...
        :toggle_background {:description "Toggle background light/dark"
                            :dot_repeat true
                            :mapping ",b"}
        ...
        :toggle_diff {:description "Toggle diff"
                      :dot_repeat true
                      :mapping ",d"}
        ...
        :toggle_spell {:description "Toggle spell check"
                       :dot_repeat true
                       :mapping ",s"}
