...
vim.keymap.set('n', '<leader>fp', builtin.builtin, { desc = 'Telescope help tags' })
...
vim.keymap.set('n', ',g', require('neogen').generate, { noremap = true, desc = 'neogen' })
vim.keymap.set({ 'n', 'x' }, '<c-s>', ':RipSubstitute<cr>', { desc = ' rip substitute' })
--vim.keymap.set('n', '<c-m>', function() require('utils.jump').two_label() end, { noremap = true, desc = 'Jump 2c' })
