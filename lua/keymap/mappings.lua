...
vim.keymap.set('n', '<leader>fo', function() require('telescope.builtin').oldfiles() end, { desc = 'Telescope buffers' })
vim.keymap.set('n', '<leader>fh', function() require('telescope.builtin').help_tags() end, { desc = 'Telescope help tags' })
vim.keymap.set('n', '<leader>fp', function() require('telescope.builtin').builtin() end, { desc = 'Telescope help tags' })
--
-- tabline
...
vim.keymap.set('n', ',g', function() require('neogen').generate() end, { noremap = true, desc = 'neogen' })
