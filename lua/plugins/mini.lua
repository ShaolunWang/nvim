...
return {{"echasnovski/mini.clue", config = _1_, keys = {"<leader>", "\\", "g", ",", "[", "]", "<c-w>"}}, {"echasnovski/mini.hipatterns", config = _2_, version = false}, {"echasnovski/mini.move", keys = {"[", "]", "<e", ">e"}, opts = {mappings = {down = "]e", left = "<e", line_down = "]e", line_left = "<e", line_right = ">e", line_up = "[e", right = ">e", up = "[e"}, options = {reindent_linewise = true}}, version = false}}
