...
vim.api.nvim_create_user_command('Janet', function()
	local toggleterm = require('toggleterm')
	toggleterm.exec('janet -e "(import spork/netrepl) (netrepl/server)"' )
end, {})
-- 
vim.api.nvim_create_user_command('Lisp', function()
	local toggleterm = require('toggleterm')
	toggleterm.exec('ros run --eval \'(ql:quickload :swank)\'  --eval \'(swank:create-server :dont-close t)\'' )
end, {})
